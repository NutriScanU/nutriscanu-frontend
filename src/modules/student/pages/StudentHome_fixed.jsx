...
function StudentHome() {
  ...
  const [isNavigating, setIsNavigating] = useState(false); // 🚫 Prevenir doble clic
  ...
  const handleClickPlanAlimentacion = () => {
    ...
    setIsNavigating(true); // 🔒 Bloquear otros clics
  ...
  return (
    <div className="student-home">
      ...
      <div className="student-home-cards">
        ...
        <div 
          className={`student-card analysis-card ${isNavigating ? 'disabled' : ''}`}
        ...
        <div
          className={`student-card nutrition-plan-card ${!recommendation ? 'disabled' : ''} ${isNavigating ? 'disabled' : ''}`}
          onClick={handleClickPlanAlimentacion}
          style={{ 
            cursor: (recommendation && !isNavigating) ? "pointer" : "not-allowed"
          }}
        >
        ...
        {/* Botón perfil */}
        <div 
          className={`student-card profile-card ${isNavigating ? 'disabled' : ''}`}
